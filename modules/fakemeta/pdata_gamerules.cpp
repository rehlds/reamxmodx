...
static cell AMX_NATIVE_CALL get_gamerules_int(AMX *amx, cell *params)
{
	...
	return PvData::GetInt(g_bReGame ? g_pGameRules : *GameRulesAddress, data, element);
}
...
static cell AMX_NATIVE_CALL set_gamerules_int(AMX *amx, cell *params)
{
	...
	PvData::SetInt(g_bReGame ? g_pGameRules : *GameRulesAddress, data, params[3], element);
...
static cell AMX_NATIVE_CALL get_gamerules_float(AMX *amx, cell *params)
{
	...
	return PvData::GetFloat(g_bReGame ? g_pGameRules : *GameRulesAddress, data, element);
}
...
static cell AMX_NATIVE_CALL set_gamerules_float(AMX *amx, cell *params)
{
	...
	PvData::SetFloat(g_bReGame ? g_pGameRules : *GameRulesAddress, data, amx_ctof(params[3]), element);
...
static cell AMX_NATIVE_CALL get_gamerules_vector(AMX *amx, cell *params)
{
	...
	PvData::GetVector(g_bReGame ? g_pGameRules : *GameRulesAddress, data, MF_GetAmxAddr(amx, params[3]), element);
...
static cell AMX_NATIVE_CALL get_gamerules_entity(AMX *amx, cell *params)
{
	...
	return PvData::GetEntity(g_bReGame ? g_pGameRules : *GameRulesAddress, data, element);
}
...
static cell AMX_NATIVE_CALL set_gamerules_entity(AMX *amx, cell *params)
{
	...
	PvData::SetEntity(g_bReGame ? g_pGameRules : *GameRulesAddress, data, params[3], element);
...
static cell AMX_NATIVE_CALL get_gamerules_string(AMX *amx, cell *params)
{
	...
	auto string = PvData::GetString(g_bReGame ? g_pGameRules : *GameRulesAddress, data, element);
...
static cell AMX_NATIVE_CALL set_gamerules_string(AMX *amx, cell *params)
{
	...
	return PvData::SetString(g_bReGame ? g_pGameRules : *GameRulesAddress, data, value, length, element);
}
